...
class CreateCommandResult
{
    ...
    public function generate()
    {
        ...
        $this->generator->setName(sprintf('Create%sCommandResult', $this->entityName));
...
BODY
        ...
        file_put_contents(sprintf('%2$s/Create%1$sCommandResult.php', $this->entityName, $this->path), "<?php \n\n" . $this->generator->generate());
    }
