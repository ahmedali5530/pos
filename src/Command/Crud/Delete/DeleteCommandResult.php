...
class DeleteCommandResult
{
    ...
    public function generate()
    {
        ...
        $this->generator->setName(sprintf('Delete%sCommandResult', $this->entityName));
...
BODY
        ...
        file_put_contents(sprintf('%2$s/Delete%1$sCommandResult.php', $this->entityName, $this->path), "<?php \n\n" . $this->generator->generate());
    }
