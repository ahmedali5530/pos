 ...
 */
final class Version20230405170404 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE closing CHANGE created_at created_at DATETIME DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE department CHANGE created_at created_at DATETIME DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE media CHANGE created_at created_at DATETIME DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE purchase CHANGE created_at created_at DATETIME DEFAULT NULL');
        $this->addSql('ALTER TABLE purchase_item CHANGE created_at created_at DATETIME DEFAULT NULL');
        $this->addSql('ALTER TABLE purchase_order_item CHANGE created_at created_at DATETIME DEFAULT NULL');
        $this->addSql('ALTER TABLE store CHANGE created_at created_at DATETIME DEFAULT NULL');
        $this->addSql('ALTER TABLE supplier CHANGE created_at created_at DATETIME DEFAULT NULL');
        $this->addSql('ALTER TABLE tax CHANGE created_at created_at DATETIME DEFAULT NULL');
        $this->addSql('ALTER TABLE terminal CHANGE created_at created_at DATETIME DEFAULT NULL');
        $this->addSql('ALTER TABLE user_account CHANGE created_at created_at DATETIME DEFAULT NULL');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE brand CHANGE created_at created_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\'');
        $this->addSql('ALTER TABLE category CHANGE created_at created_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\'');
        $this->addSql('ALTER TABLE closing CHANGE created_at created_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\'');
        ...
        $this->addSql('ALTER TABLE department CHANGE created_at created_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\'');
        ...
        $this->addSql('ALTER TABLE purchase_item CHANGE created_at created_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\'');
        $this->addSql('ALTER TABLE purchase_order_item CHANGE created_at created_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\'');
        $this->addSql('ALTER TABLE store CHANGE created_at created_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\'');
        $this->addSql('ALTER TABLE supplier CHANGE created_at created_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\'');
        $this->addSql('ALTER TABLE tax CHANGE created_at created_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\'');
        $this->addSql('ALTER TABLE terminal CHANGE created_at created_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\'');
        $this->addSql('ALTER TABLE user_account CHANGE created_at created_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\'');
    }
}
